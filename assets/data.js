  ...
  projects: [
    {
      ...
      overview: [
        'The Exocoetidae family of flying fish is famous for its members’ fantastical ability to leap from the waves and glide vast distances. This unique class of fish manages to do what no others can by swimming aggressively towards the surface of the water, lifting all but the ventral side of their caudal fin out of the water as they spread their pectoral wings and engage in taxiing, before fully taking to the air. In a good wind, flying fish can extend their flight distance from 50 meters to over 400. These fish engage in complex and powerful fluid interactions near the water's surface but are very difficult to study using traditional natural biology methods.', 
        'To investigate the physical principles behind taxiing behaviors in flying fish, we develop a robotic model organism (RMO) of a flying fish designed to replicate this hard-to-study behavior in a controlled setting. The RMO focuses heavily on body morphology to study flow dynamics, focusing on anatomical fidelity. Field data and morphological analysis of actual fish samples were used to develop an accurate representation of the flying fish.',
      ...
      report: { title: 'Design & Trial Report', file: 'files/flying-fish.pdf', pages: '34 pages', size: 'PDF' },
      gallery: [
